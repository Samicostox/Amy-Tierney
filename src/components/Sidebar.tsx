...
const SidebarHeader = () => {
  return (
    <div className="flex space-x-2">
      <Image
        src="https://res.cloudinary.com/dl2adjye7/image/upload/v1746969407/39D835DC-FB96-4022-89F0-E4EDA5F4CC4B_tcbeye.jpg"
        alt="Avatar"
        height="40"
        width="40"
      ...
      <div className="flex text-sm flex-col">
        <p className="font-bold text-primary">Amy Tierney</p>
        <p className="font-light text-secondary">PhD Student</p>
      </div>
    </div>
  );
};
