    ...
    <div>
      ...
      <div className="max-w-4xl">
        <Paragraph className=" mt-4">
          I&apos;m Amy Tierney - a second year pure mathematics PhD student at the University of Birmingham, supervised by Professor Jonathan Bennett. My focus is in harmonic analysis, with my current interest in weighted extension operator inequalities and their variants.
        </Paragraph>
        <Paragraph className=" mt-4">
          My undergraduate degree also took place at the University of Birmingham, with my Masters project on the the heat flow monotonicity phenomena in mathematical analysis, also supervised by Professor Jonathan Bennett.
        </Paragraph>

        <Paragraph className=" mt-4">
          Additional to my PhD, I am a part of the Birmingham Piscopia Committee. At Piscopia, we aim to
        </Paragraph>
        <Paragraph className=" mt-4">
